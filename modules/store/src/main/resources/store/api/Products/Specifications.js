...
var dao = require('store/data/dao/Products/Specifications');
var http = require('store/api/http');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/store/api/Specifications.js/' + entity.Id);
